/* =========================================================================
   ...
   ---------------------------------------------------------------------
   旧版の問題: Lv7=300ms/insightStage1（瞬殺）、Lv1=insightStage4（置物）
   v2 方針:
     1) 反応時間を人間のレンジ(1.2〜9.5秒)に収める
     2) insightStage（気づく札）1〜3、札が進むほど速くなる
     3) hesitate（迷って1札見送る）で取りこぼしを作る
     4) errorRate で官能基が近い別カードを叩く（人間と同じミス）
     5) ラバーバンド: 点差・連勝で ±25% だけ強さを自動調整 → 常に競る
     6) 最終札では必ずアクション（進行が止まらない）
========================================================================= */
class CPUPlayer {
    constructor(level = 3) {
